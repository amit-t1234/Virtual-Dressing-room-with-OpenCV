...
@app.route('/predict/<number>', methods = ['POST', 'GET'])
def predict(number):
    shirtno = int(number)
    ...
    cap=cv2.cv2.VideoCapture('http://192.168.0.100:4747/mjpegfeed')
    ih=shirtno
    # i=pantno
    while True:
        imgarr=["static/images/Tops4/1.png",'static/images/Tops4/2.png','static/images/Tops4/3.png','static/images/Tops4/4.png']
        ...
        face_cascade=cv2.cv2.CascadeClassifier('data/haarcascade_frontalface_default.xml')
